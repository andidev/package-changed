...
var find_packagelock_1 = require("./find-packagelock");
function isPackageChanged(options, callback) {
    var _a, _b;
    if (options === void 0) { options = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var _c, hashFilename, _d, cwd, lockfile, skipWriteHash, packagePath, packagelockPath, packageHashPath, writeHash, packageHashPathExists, recentDigest, previousDigest, isChanged, result, canWriteHash;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    _c = options.hashFilename, hashFilename = _c === void 0 ? '.packagehash' : _c, _d = options.cwd, cwd = _d === void 0 ? process.cwd() : _d, lockfile = options.lockfile, skipWriteHash = options.skipWriteHash;
                    ...
                    packagelockPath = find_packagelock_1.findPackagelock({ cwd: cwd });
